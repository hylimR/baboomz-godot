namespace Baboomz.Simulation
{
    ...
    public struct TerrainBiome
    {
        ...
        // Folder name under Art/Backgrounds/ that the parallax renderer should load.
        // Empty = fall back to "Default". Art assets may not exist yet for every biome;
        // missing PNGs gracefully fall back to the default set then to colored rects.
